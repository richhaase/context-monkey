...
async function install(options = {}) {
  ...
  try {
    ...
    console.log('1. Run \'/monkey:stack-scan\' in Claude Code to detect your tech stack');
    console.log('2. Use \'/monkey:review-code\' to get comprehensive code reviews via subagent');
    console.log('3. Use \'/monkey:deep-dive\' for thorough research and analysis');
    console.log('');
